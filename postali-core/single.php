            ...
            <div class="columns">
                <div class="column-66 block">
                    <div class="article-single-featured-image">
                        <p class="date">Published On: <?php $post_date = get_the_date( 'F j, Y' ); echo $post_date; ?></p>
                        <?php $categories = get_the_category();
                        if ( ! empty( $categories ) ) { ?>
                        <p>Category: <?php echo esc_html( $categories[0]->name ); ?></p>
                        <div class="spacer-30"></div>
                        <?php } ?>
                    ...
                    <?php the_content(); ?>
                    <div class="spacer-30"></div>
                    <p class="sidebar-more"><a href="/blog/" class="btn" title="Read more results">All Blogs</a></p>
                </div>
                <div class="column-33 sidebar-block block">
                    <div class="sidebar-menu">
                        <div class="sidebar-header">RECENT BLOGS</div>
                        <div class="sidebar-menu">
                            ...
                            <div class="spacer-30"></div>
                            <p class="sidebar-more"><a href="/blog/" title="Read more results">All Blogs</a> <span class="icon-tick-down"></span></p>
